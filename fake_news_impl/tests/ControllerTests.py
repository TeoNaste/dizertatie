...
class ControllerTests(unittest.TestCase):
    ...
    def test_most_freq_words(self,mock_data_loader):
        ...
        n = 5
        controller = TrainerController(mock_data_loader)
    ...
    @mock.patch('dataLoaders.FileDataLoader', autospec=True)
    def test_to_word_embeddings(self, mock_data_loader):
        dataset = np.array([
            [0, 'coronavirus group represent group english', 'expls'],
            [1, 'man died coronavirus vaccine', 'exp'],
            [2, 'coronavirus vaccine man man coronavirus', 'expl'],
    ...
    @mock.patch('dataLoaders.FileDataLoader', autospec=True)
    def test_text_to_indexes(self, mock_data_loader):
        dataset = np.array([
            [0, 'coronavirus group represent group english', 'expls'],
            [1, 'man died coronavirus vaccine', 'exp'],
            [2, 'coronavirus vaccine man man coronavirus', 'expl'],
        ...
        result_indexes, result_weights = controller.text_to_indexes(len(vocab),dataset)
